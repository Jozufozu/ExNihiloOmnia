...
public class ModelPorcelainBucket implements IModel, IModelCustomData, IRetexturableModel {
    public static final ModelResourceLocation LOCATION = new ModelResourceLocation(new ResourceLocation(ENO.MODID, "porcelain_bucket"), "inventory");
    ...
    public static final IModel MODEL = new ModelPorcelainBucket();
    ...
    public ModelPorcelainBucket()
    {
        this(null, null, null, null, false);
    }

    public ModelPorcelainBucket(ResourceLocation baseLocation, ResourceLocation liquidLocation, ResourceLocation coverLocation, Fluid fluid, boolean flipGas)
    {
                            ...
                            Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter)
    {
        ...
        return new ModelPorcelainBucket.BakedDynBucket(this, builder.build(), fluidSprite, format, Maps.immutableEnumMap(transformMap), Maps.<String, IBakedModel>newHashMap());
    }
     ...
     */
    @Override
    public ModelPorcelainBucket process(ImmutableMap<String, String> customData)
    {
        ...
        return new ModelPorcelainBucket(baseLocation, liquidLocation, coverLocation, fluid, flip);
    }
     ...
     */
    @Override
    public ModelPorcelainBucket retexture(ImmutableMap<String, String> textures)
    {
        ...
        return new ModelPorcelainBucket(base, liquid, cover, fluid, flipGas);
    }
    ...
    {
        public static final ModelPorcelainBucket.BakedDynBucketOverrideHandler INSTANCE = new ModelPorcelainBucket.BakedDynBucketOverrideHandler();
        ...
        public IBakedModel handleItemState(IBakedModel originalModel, ItemStack stack, World world, EntityLivingBase entity)
        {
            ...
            ModelPorcelainBucket.BakedDynBucket model = (ModelPorcelainBucket.BakedDynBucket)originalModel;
    ...
    private static final class BakedDynBucket implements IPerspectiveAwareModel
    {
        ...
        private final ModelPorcelainBucket parent;
        // FIXME: guava cache?
        ...
        public BakedDynBucket(ModelPorcelainBucket parent,
        ...
        {
            return ModelPorcelainBucket.BakedDynBucketOverrideHandler.INSTANCE;
        }
