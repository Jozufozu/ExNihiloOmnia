...
public class OutputStateLogicPackingIce extends BarrelLogic{
	...
	{
		if (barrel.getContents().getItem() == Item.getItemFromBlock(Blocks.ICE) && PositionHelper.isRainingAt(barrel.getWorld(), barrel.getPos()) && barrel.getWorld().getBiomeForCoordsBody(barrel.getPos()).getTempCategory().equals(Biome.TempCategory.COLD))
		{
