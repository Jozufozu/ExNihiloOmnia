...
public class TemplateExNihiloModerate extends TemplateGenerator {
	...
	public static void generate(String path) {
		generateTemplateFile(path + File.separator + "ex_nihilo_moderate_overworld.json", getOverworldTemplate());
	}
	...
	private static Template getOverworldTemplate() {
		...
		chest.getContents().add(new TemplateItem("exnihiloomnia:ASH", 64, 0)); //BONE Meal
		blocks.add(chest);
