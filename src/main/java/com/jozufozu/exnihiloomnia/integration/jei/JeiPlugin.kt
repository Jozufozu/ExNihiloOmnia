...
class JeiPlugin : IModPlugin {
    ...
    override fun register(registry: IModRegistry) {
        ...
        registry.addRecipes(RegistryManager.SIFTING.values, SieveRecipeCategory.UID)
        registry.addRecipes(RegistryManager.COMPOST.values, CompostRecipeCategory.UID)
        registry.addRecipes(RegistryManager.MELTING.values, MeltingRecipeCategory.UID)
        registry.addRecipes(RegistryManager.HAMMERING.values, HammerRecipeCategory.UID)
